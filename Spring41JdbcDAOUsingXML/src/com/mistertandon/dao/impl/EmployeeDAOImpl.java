...
public class EmployeeDAOImpl extends JdbcDaoSupport implements EmployeeDAO {
	...
	public void createEmployeeEDAO(Employee employee) {
		...
		addedEmpId = getJdbcTemplate().update(sql,
	...
	public Employee getEmployeeByIdEDAO(int id) {
		...
		Employee employeeObj = getJdbcTemplate().queryForObject(sql, new EmployeeRowMapper(), id);
	...
	public void deleteEmployeeByIdEDAO(int id) {
		...
		returnedId = getJdbcTemplate().update(sql, id);
	...
	public void updateEmployeeEmailByIdEDAO(String emailId, int employeeId) {
		...
		returnedId = getJdbcTemplate().update(sql, emailId, employeeId);
